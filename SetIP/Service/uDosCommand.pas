...
type
  ...
  strict private
    ...
    FOnNewChar: TNewCharEvent;
    FOnNewLine: TNewLineEvent;
    FOnStarted: TNotifyEvent;  // added by Loan
  ...
  published
    ...
    property OnStarted: TNotifyEvent read FOnStarted write FOnStarted; // evernt for the start of the process ; added by Loan...
...
begin
  ...
  if Assigned(FOnStarted) then  // added by Loan...
    FOnStarted(Self);
